...
if __name__ == '__main__':
    ...
    calc5.get_data()
    calc6 = CameraAndLensCalculator(camera={'Make_Model':'Canon 80D', 'pixel_size':3.7}, lens={'Make_Model':'Fluorostar 156', 'focal_length':1217, 'f_stop':7.8}, object={'obj_angular_size':50,'obj_au':3.95})
    print(f"\nCanon 80D Paired with {calc6.data['lens']['Make_Model']}")
    calc6.get_data()
    calc7 = CameraAndLensCalculator(camera={'Make_Model':'Canon 80D', 'pixel_size':3.7}, lens={'Make_Model':'RedCat 71 APO', 'focal_length':350, 'f_stop':4.9}, object={'obj_angular_size':50,'obj_au':3.95})
    print(f"\nCanon 80D Paired with {calc7.data['lens']['Make_Model']}")
    calc7.get_data()
    calc8 = CameraAndLensCalculator(camera={'Make_Model':'Canon 80D', 'pixel_size':3.7}, lens={'Make_Model':'Tokina 11 2.8', 'focal_length':11, 'f_stop':2.8}, object={'obj_angular_size':50,'obj_au':3.95})
